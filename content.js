...
const CASE_LAW_DICTIONARY = {
    ...
    "LQP v City of York Council 2022 EAT 196": "The Appellant (Claimant before the Tribunal) contended that an Employment Judge had erred in law in refusing an application to amend so as to permit him to bring a claim of disability discrimination based upon perceived, rather than actual, disability, and, in respect of the refusal of an anonymity order. The appeal was allowed in respect of both grounds of appeal. The Judge erred in his approach to the application for amendment by, arguably, ‘short-cutting’ the required analyssi and evaluration of the relative hardship of granting or refusing the amendment. In respect of the anonymity order, the Judge erred in that he failed to have proper regard to new evidence and consider and balance the Claimant’s Article 2",
