...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* FIX 1: HIGH CONTRAST FEATURED CASES */
        .case-item--featured { 
            ...
            <nav style="margin-top: 3rem;">
                <div class="nav-section">
                    ...
                    <nav class="sidebar-nav">
                        <a data-hash="#profile-view" class="nav-active" onclick="handleLinkClick(this)">Profile & Cases</a>
            ...
            <section id="about">
                ...
                <div style="margin-top: 3rem; border-top: 1px solid var(--line-color); padding-top: 2rem;">
                     ...
                     <ul class="content-list" style="max-width: none; list-style:none; padding:0; line-height:1.8;">
                        ...
                        <li><strong>PhD, MPhil</strong> – University of Cambridge</li>
...
<script>
    ...
    function renderCases() {
        ...
        matches.forEach(item => {
            ...
            // FIX 3: Conditional Solicitor Badge to prevent empty tags
